...
export default function EmployerSolutions() {
  ...
  return (
    <section
      id="employers"
      className="relative min-h-[90svh] w-full bg-sp-white text-sp-ink py-20 sm:py-28 lg:py-32 flex flex-col justify-center border-b border-sp-lightGray overflow-hidden select-none"
    >
